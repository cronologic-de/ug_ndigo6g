...
(see Figure `Fig 2.3 <#target-fig4>`_  ) on the
...
`Fig 2.3 <#target-fig4>`_ on page shows the location of the
...
`Fig 2.3 <#target-fig4>`_ on page . Connector C1 is used
...
effectively cutting the dynamic range in half (see Figure `Fig 2.6 <target-fig7>`_ ). By shifting the DC baseline to
