...
:cpp:member:`crono_packet::data`, that is, the packet-data payload,
depends on :cpp:member:`ndigo6g12_configuration::output_mode`. The length of
the :cpp:member:`~crono_packet::data` array is encoded in
:cpp:member:`crono_packet::length`. Be aware that
:cpp:member:`~crono_packet::length` is in multiples of 64 bit, while
the size of the fields of :cpp:member:`~crono_packet::data` depends on
...
:c:macro:`NDIGO6G12_APP_TYPE_AVRG`. See :doc:`avrgdata` for more
information.
