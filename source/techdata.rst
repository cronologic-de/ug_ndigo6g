...
+----------------------+------------------------------------------------+------+---------+-----+---------+
| t\ :sub:`Pulse,TDC`  | Pulse length TDC inputs                        | 0.25 | 5       | 200 | ns      |
+----------------------+------------------------------------------------+------+---------+-----+---------+
| t\ :sub:`Pulse,CTRL` | Pulse length control inputs (TRG and GATE)     | 2    | 5       | 200 | ns      |
+----------------------+------------------------------------------------+------+---------+-----+---------+
| t\ :sub:`DPR`        | Double-pulse resolution                        | 5    |         |     | ns      |
+----------------------+------------------------------------------------+------+---------+-----+---------+
| N\ :sub:`Multihit`   | Number of hits limited solely by t\ :sub:`DPR` | 15   |         |     | Hits/Ch |
+----------------------+------------------------------------------------+------+---------+-----+---------+
| t\ :sub:`Rise`       | Pulse Edge 20% to 80%                          |      |         |  10 | ns      |
+----------------------+------------------------------------------------+------+---------+-----+---------+
| t\ :sub:`Fall`       | Pulse Edge 80% to 20%                          |      |         |  10 | ns      |
+----------------------+------------------------------------------------+------+---------+-----+---------+
| f\ :sub:`Burst`      | Burst rate for up to 512 hits per channel      |      |         | 12  | MHits/s |
+----------------------+------------------------------------------------+------+---------+-----+---------+
| f\ :sub:`Readout,1`  | Sustained readout rate per channel             |      |         | 11.6| MHits/s |
+----------------------+------------------------------------------------+------+---------+-----+---------+
| f\ :sub:`Readout,4`  | Sustained readout rate over all channels       |      |         | 30  | MHits/s |
+----------------------+------------------------------------------------+------+---------+-----+---------+
